...
export const HeartIcon = (props) => (
  <svg viewBox="0 0 24 24" width="50" height="50" transform="translate(0 15)"{...props}>
    <path
      fill="currentColor"
...
export const DownloadIcon = (props) => (
    <svg viewBox="0 0 16 16" width="28" height="28" {...props}>
        <path
        fill="currentColor"
        d="M0 8a8 8 0 1 1 16 0A8 8 0 0 0 0 8zm7.5-6.5v5.793L5.354 7.146a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 7.293V1.5a.5.5 0 0 0-1 0z"
        />
    </svg>
);

export const ReactIcon = (props) => (
  <svg viewBox="-11.5 -10.23174 23 20.46348" width="28" height="28" {...props}>
...
<g id="logo" transform="translate(53, 53)">
  ...
  <g id="gear" mask="url(#holes)">
    ...
    <g id="mounts">
      <polygon id="mount" stroke="currentColor" strokeWidth="6" strokeLinejoin="round" points="-7,-42 0,-35 7,-42"/>
...
export const NextjsIcon = (props) => (
    <svg width="42" height="42" viewBox="-1.5 -1.5 18.00 18.00" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
...
export const PythonIcon = (props) => (
    <svg width="56" height="56" viewBox="0 0 32.00 32.00" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
        <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
        <g id="SVGRepo_iconCarrier"> 
...
export const BlueskyIcon = (props) => (
    <svg viewBox="0 0 24 24" width="28" height="28" {...props}>
        <path
            fill="currentColor"
            d="M12 10.8c-1.087-2.114-4.046-6.053-6.798-7.995C2.566.944 1.561 1.266 1.467 1.467c-.293.629-.468 1.992-.468 3.972 0 2.116.346 3.876.868 5.08A12.354 12.354 0 0 0 12 10.8zm0 0c1.087-2.114 4.046-6.053 6.798-7.995C21.434.944 22.439 1.266 22.533 1.467c.293.629.468 1.992.468 3.972 0 2.116-.346 3.876-.868 5.08A12.354 12.354 0 0 1 12 10.8zm9.848 3.42c.194-.328.376-.678.545-1.052.165-.365.314-.754.444-1.166a12.4 12.4 0 0 0 .32-1.197c.075-.402.138-.82.186-1.256.048-.435.07-.889.07-1.364 0-.474-.022-.929-.07-1.364a12.49 12.49 0 0 0-.186-1.256 12.4 12.4 0 0 0-.32-1.197 12.423 12.423 0 0 0-.444-1.166 12.435 12.435 0 0 0-.545-1.052c-.392-.658-.832-1.255-1.318-1.794a12.475 12.475 0 0 0-1.599-1.506c-.587-.47-1.215-.89-1.876-1.263A12.48 12.48 0 0 0 17.067.3a12.4 12.4 0 0 0-1.197-.32A12.49 12.49 0 0 0 14.614.074C14.179.026 13.725.004 13.25.004c-.474 0-.929.022-1.364.07a12.49 12.49 0 0 0-1.256.186 12.4 12.4 0 0 0-1.197.32 12.4 12.4 0 0 0-1.166.444 12.435 12.435 0 0 0-1.052.545c-.658.392-1.255.832-1.794 1.318a12.475 12.475 0 0 0-1.506 1.599c-.47.587-.89 1.215-1.263 1.876a12.48 12.48 0 0 0-1.023 1.888 12.4 12.4 0 0 0-.32 1.197 12.49 12.49 0 0 0-.186 1.256c-.048.435-.07.889-.07 1.364 0 .474.022.929.07 1.364a12.49 12.49 0 0 0 .186 1.256 12.4 12.4 0 0 0 .32 1.197c.13.412.279.801.444 1.166.17.374.351.724.545 1.052C7.783 14.88 10.464 18 12 18s4.217-3.12 9.848-3.78z"
        />
    </svg>
);
